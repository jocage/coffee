...
import { MobileBrewLogWizard } from "@/components/forms/mobile-brew-log-wizard";
...
export function BrewLogForm({
  ...
  const action = brewLog ? updateBrewLogAction : saveBrewLogAction;
      ...
      <Card className="hidden lg:block">
        ...
        <form action={action} className="mt-5 grid gap-4 md:grid-cols-2">
          ...
          <Field
            ...
            label="Temp (C)"
            value={String(brewLog?.temperatureCelsius ?? selectedRecipe?.temperatureCelsius ?? 93)}
          />
          <Field
            id="brewTimeSeconds"
            label="Brew time (s)"
