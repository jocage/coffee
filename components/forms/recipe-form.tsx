...
import { MobileRecipeWizard } from "@/components/forms/mobile-recipe-wizard";
...
export function RecipeForm({
  ...
  return (
    <>
      <MobileRecipeWizard recipe={recipe} action={action} defaultVisibility={defaultVisibility} submitLabel={submitLabel} />
      <form action={action} noValidate className="hidden gap-5 lg:grid xl:grid-cols-[0.9fr_0.8fr_1fr]">
        ...
        <Card>
          ...
          <div className="mt-5 flex gap-3">
            <Button type="submit" name="intent" value="draft">{submitLabel}</Button>
            <Button type="submit" name="intent" value="publish" variant="secondary">
              Publish
            </Button>
          </div>
        </Card>
