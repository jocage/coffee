      ...
      <Card>
        ...
        <form action={saveProfileAction} className="mt-5 grid gap-4">
          <div className="grid gap-4 md:grid-cols-2">
            <MediaUploadField entityType="avatar" label="Update avatar" urlFieldName="avatarUrl" assetFieldName="avatarAssetId" initialUrl={user.avatarUrl} />
            <MediaUploadField entityType="cover" label="Update cover" urlFieldName="coverUrl" assetFieldName="coverAssetId" initialUrl={user.coverUrl} />
          </div>
          <div>
